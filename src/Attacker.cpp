...
Attacker::Attacker()
    : Collider(catSpritePath, DIR::DIRECTION::LEFT, {WINDOW_WIDTH - 20, 360},
               100, 10.0f),
...
Attacker::Attacker(sf::Vector2f a)
    : Collider(catSpritePath, DIR::DIRECTION::LEFT, {WINDOW_WIDTH, a.y + 47.0f},
               100, 10.0f),
      animator(catSpritePath, sf::Vector2u(4, 2), 1.0f / 3.0f) {
  updateAnimation(0.0f);
  scale(0.5, 0.5);
...
Attacker::Attacker(sf::Vector2f a, string b)
    : Collider(b, DIR::DIRECTION::LEFT, {WINDOW_WIDTH, a.y + 47.0f}, 100,
               10.0f),
