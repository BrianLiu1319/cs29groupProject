...
int main() {
  ...
  *********************************/
  // ADDNEW: don't resize, i'm afraid itll break the menus... and add the
  // sf::Style::Close so the player can close the window!
  sf::RenderWindow window(sf::VideoMode(1280, 720), "Dogs vs Cats",
  ...
  *********************************/
  while (window.isOpen()) {
    ...
    while (window.pollEvent(evnt)) {
      ...
      if (gameState == states::enterHighScore &&
          evnt.type == sf::Event::TextEntered) {
