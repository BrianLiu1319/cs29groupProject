...
private:
  ...
  const std::string creditsButtonTexturePath =
      assetFolder + "credits button.png";
  ...
  const std::string nextButtonInvPath =
      assetFolder + "next button inverted.png";
  const std::string prevButtonPath = assetFolder + "prev button.png";
  const std::string prevButtonInvPath =
      assetFolder + "prev button inverted.png";
  ...
  sf::Texture creditsTexture, howtoTexture, creditsTextureInv, howtoTextureInv,
      sfxTexture, sfxMuteTexture, sfxTextureInv, sfxMuteTextureInv,
      musicTexture, musicMuteTexture, musicTextureInv, musicMuteTextureInv,
      backTexture, backTextureInv, nextTexture, prevTexture, nextTextureInv,
      prevTextureInv;
...
public:
  ...
  void setSfxTexture(std::string path, std::string pathInv,
                     std::string pathMute, std::string pathMuteInv);
  void setMusicTexture(std::string path, std::string pathInv,
                       std::string pathMute, std::string pathMuteInv);
