...
HowToPlay::HowToPlay(sf::Vector2f windowSize) : Menu(windowSize) {
    ...
    guidePage.setPosition(windowSize.x / 2.0f - guidePage.getSize().x / 2.0f, windowSize.y / 2.0f - guidePage.getSize().y / 2.0f);
    
    //Set Buttons
    nextButton.setSize(sf::Vector2f(buttonSize.x / 2, buttonSize.x));
    nextButton.setPosition(sf::Vector2f(centerButtonPos.x + windowSize.x / 1920.0f * 800.0f - buttonSize.x / 2.0f, centerButtonPos.y));
    nextButton.setOutlineThickness(buttonSize.y / 20.0f);
    prevButton.setSize(sf::Vector2f(buttonSize.x / 2, buttonSize.x));
    prevButton.setPosition(sf::Vector2f(centerButtonPos.x - windowSize.x / 1920.0f * 800.0f, centerButtonPos.y));
